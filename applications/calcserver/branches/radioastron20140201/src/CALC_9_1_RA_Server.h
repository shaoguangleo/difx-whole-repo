/*	@(#)CALC_9_1_RA_Server.h  version 1.01	created 2012Feb16 14:40
	%% include for the CALC_9_1_RA Server RPC interface
	LANGUAGE: C (include file)
	ENVIRONMENT: vxWorks, Solaris, Linux
*/

#ifndef _CALC_9_1_RA_H_RPCGEN
#define	_CALC_9_1_RA_H_RPCGEN

#include <rpc/rpc.h>

#define CALC_9_1_RA_SERVER_STRUCT_CODE_0 0x0		/* Request for the calcserver
													   ...
													   call.
													*/
#define CALC_9_1_RA_SERVER_STRUCT_CODE_5_0_0 150	/* Original version 5 */
#define CALC_9_1_RA_SERVER_STRUCT_CODE_5_1_0 0x0510 /* Include spacecraft capabilities by James M Anderson */
#define CALC_9_1_RA_SERVER_STRUCT_CODE_CURRENT CALC_9_1_RA_SERVER_STRUCT_CODE_5_1_0
...
typedef struct getCALC_9_1_RA_arg getCALC_9_1_RA_arg;
...
typedef struct CALC_9_1_RARecord CALC_9_1_RARecord;
...
struct getCALC_9_1_RA_res {
	...
	union {
		...
		char *errmsg;
	} getCALC_9_1_RA_res_u;
};
typedef struct getCALC_9_1_RA_res getCALC_9_1_RA_res;

#define	CALC_9_1_RAPROG ((unsigned long)(0x20000341))
#define	CALC_9_1_RAVERS ((unsigned long)(1))
#define	GETCALC_9_1_RA ((unsigned long)(1))
extern	getCALC_9_1_RA_res * getcalc_9_1_ra_1();
extern int calc_9_1_raprog_1_freeresult();

/* the xdr functions */
extern bool_t xdr_getCALC_9_1_RA_arg();
extern bool_t xdr_CALC_9_1_RARecord();
extern bool_t xdr_getCALC_9_1_RA_res();

#endif /* !_CALC_9_1_RA_H_RPCGEN */
