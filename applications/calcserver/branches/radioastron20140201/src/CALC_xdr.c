...
static bool_t
xdr_getCALC_arg_5_0_0(xdrs, struct_code, objp)
	register XDR *xdrs;
        long struct_code;
	getCALC_arg *objp;
{
...
static bool_t
xdr_getCALC_arg_5_1_0(xdrs, struct_code, objp)
	register XDR *xdrs;
        long struct_code;
	getCALC_arg *objp;
{
	...
	getCALC_arg *objp;
{
    if(xdrs->x_op == XDR_DECODE) {
        ...
        if (!xdr_long(xdrs, &struct_code))
            return (FALSE);
        switch(struct_code) {
        case CALC_SERVER_STRUCT_CODE_0:
        case CALC_SERVER_STRUCT_CODE_5_0_0:
            return xdr_getCALC_arg_5_0_0(xdrs, struct_code, objp);
        case CALC_SERVER_STRUCT_CODE_5_1_0:
            return xdr_getCALC_arg_5_1_0(xdrs, struct_code, objp);
        }
        return (FALSE);
    }
        ...
        case CALC_SERVER_STRUCT_CODE_0:
        case CALC_SERVER_STRUCT_CODE_5_0_0:
            return xdr_getCALC_arg_5_0_0(xdrs, objp->struct_code, objp);
        case CALC_SERVER_STRUCT_CODE_5_1_0:
            return xdr_getCALC_arg_5_1_0(xdrs, objp->struct_code, objp);
        }
        return (FALSE);
    }
    else {
        fprintf(stderr, "Have xdr_getCALC_arg call with xdrs->x_op == %d\n", (int)xdrs->x_op);
        return (FALSE);
    }
    return (FALSE);
}
...
bool_t
xdr_CALCRecord_5_0_0(xdrs, struct_code, objp)
	register XDR *xdrs;
        long struct_code;
	CALCRecord *objp;
{
...
static bool_t
xdr_CALCRecord_5_1_0(xdrs, struct_code, objp)
	register XDR *xdrs;
        long struct_code;
	CALCRecord *objp;
{
	...
	CALCRecord *objp;
{
    if(xdrs->x_op == XDR_DECODE) {
        ...
        case CALC_SERVER_STRUCT_CODE_0:
        case CALC_SERVER_STRUCT_CODE_5_0_0:
            return xdr_CALCRecord_5_0_0(xdrs, struct_code, objp);
        case CALC_SERVER_STRUCT_CODE_5_1_0:
            return xdr_CALCRecord_5_1_0(xdrs, struct_code, objp);
        }
        return (FALSE);
    }
    else if((xdrs->x_op == XDR_ENCODE) || (xdrs->x_op == XDR_FREE)) {
        ...
        case CALC_SERVER_STRUCT_CODE_0:
        case CALC_SERVER_STRUCT_CODE_5_0_0:
            return xdr_CALCRecord_5_0_0(xdrs, objp->struct_code, objp);
        case CALC_SERVER_STRUCT_CODE_5_1_0:
            return xdr_CALCRecord_5_1_0(xdrs, objp->struct_code, objp);
        }
        return (FALSE);
    }
    else {
        fprintf(stderr, "Have xdr_CALCRecord call with xdrs->x_op == %d\n", (int)xdrs->x_op);
        return (FALSE);
    }
    return (FALSE);
}
