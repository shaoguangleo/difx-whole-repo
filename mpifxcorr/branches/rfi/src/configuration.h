...
//@{
  ...
  inline int getMaxThreadResultVectorCount() const { return maxthreadresultveccount; }
  ...
  inline string getRFIFilterFilename() const { return rfifilterfilename; }
  inline string getRFIFilterFormat() const { return rfifilterformat; }
