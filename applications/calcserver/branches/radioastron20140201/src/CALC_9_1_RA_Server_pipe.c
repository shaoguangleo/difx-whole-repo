...
/* This file is based on the CALC5Server.c code originally found within
   the DiFX code area, and the CALC_9_1_RA_Server.c code that was based
   on that code.
*/
...
FILE  *flog = NULL;
char spawn_time[64];
const char Version[] = "CALC_9_1_RA_Server_pipe Version 2015-08-26 0x01000000";
const uint64_t uVersion = UINT64_C(0x01000000);
const struct CALCSERVER9_1_RA_MODEL_DELAY_ARGUMENT *p_arg;
int ifirst = 0;
...
static int_fast32_t open_flog(const char* const tmpdir, const char* const name, const char* const id)
{
	...
	printf("opened new CALC_9_1_RA_Server_pipe flog file : %s\n", filename);
	fflush(stdout);
	return 0;
}
...
static int_fast32_t redirect_stdout(const char* const tmpdir, const char* const name, const char* const id)
{
	...
	printf("opened new CALC_9_1_RA_Server_pipe stdout file : %s\n", filename);
	fflush(stdout);
	return 0;
}
...
/******************************************************************************/
static int_fast32_t calc_9_1_raprog_1 (const uint_fast64_t command_number, const uint_fast32_t ItemNumber, const struct CALCSERVER9_1_RA_MODEL_DELAY_ARGUMENT* const argument, struct CALCSERVER9_1_RA_MODEL_DELAY_RESPONSE* const response)
/*
 ...
 */
{
	...
	if(argument->verbosity >= 1)
	{
		...
		fprintf(flog, "calc_9_1_raprog_1 for item %"PRIuFAST32"\n", ItemNumber);
	}

#warning "remove the following line when CALC_9_1_RA is fixed to support msa"
	...
	if(argument->verbosity >= 3)
	{
		...
		printf("request arg: source_pos[0]  = %e\n", argument->source_pos[0]);
		printf("request arg: source_pos[1]  = %e\n", argument->source_pos[1]);
		printf("request arg: source_pos[2]  = %e\n", argument->source_pos[2]);
		printf("request arg: source_vel[0]  = %e\n", argument->source_vel[0]);
		printf("request arg: source_vel[1]  = %e\n", argument->source_vel[1]);
		printf("request arg: source_vel[2]  = %e\n", argument->source_vel[2]);
		printf("request arg: source_epoch   = %e\n", argument->source_epoch);
		printf("request arg: source_parallax= %e\n", argument->source_parallax);

		printf("request arg: source_pointing_pos_a_x[0]  = %e\n", argument->pointing_pos_a_x[0]);
		printf("request arg: source_pointing_pos_a_x[1]  = %e\n", argument->pointing_pos_a_x[1]);
		printf("request arg: source_pointing_pos_a_x[2]  = %e\n", argument->pointing_pos_a_x[2]);
		printf("request arg: source_pointing_vel_a_x[0]  = %e\n", argument->pointing_vel_a_x[0]);
		printf("request arg: source_pointing_vel_a_x[1]  = %e\n", argument->pointing_vel_a_x[1]);
		printf("request arg: source_pointing_vel_a_x[2]  = %e\n", argument->pointing_vel_a_x[2]);

		printf("request arg: source_pointing_pos_a_y[0]  = %e\n", argument->pointing_pos_a_y[0]);
		printf("request arg: source_pointing_pos_a_y[1]  = %e\n", argument->pointing_pos_a_y[1]);
		printf("request arg: source_pointing_pos_a_y[2]  = %e\n", argument->pointing_pos_a_y[2]);
		printf("request arg: source_pointing_vel_a_y[0]  = %e\n", argument->pointing_vel_a_y[0]);
		printf("request arg: source_pointing_vel_a_y[1]  = %e\n", argument->pointing_vel_a_y[1]);
		printf("request arg: source_pointing_vel_a_y[2]  = %e\n", argument->pointing_vel_a_y[2]);

		printf("request arg: source_pointing_pos_a_z[0]  = %e\n", argument->pointing_pos_a_z[0]);
		printf("request arg: source_pointing_pos_a_z[1]  = %e\n", argument->pointing_pos_a_z[1]);
		printf("request arg: source_pointing_pos_a_z[2]  = %e\n", argument->pointing_pos_a_z[2]);
		printf("request arg: source_pointing_vel_a_z[0]  = %e\n", argument->pointing_vel_a_z[0]);
		printf("request arg: source_pointing_vel_a_z[1]  = %e\n", argument->pointing_vel_a_z[1]);
		printf("request arg: source_pointing_vel_a_z[2]  = %e\n", argument->pointing_vel_a_z[2]);

		printf("request arg: source_pointing_pos_b_x[0]  = %e\n", argument->pointing_pos_b_x[0]);
		printf("request arg: source_pointing_pos_b_x[1]  = %e\n", argument->pointing_pos_b_x[1]);
		printf("request arg: source_pointing_pos_b_x[2]  = %e\n", argument->pointing_pos_b_x[2]);
		printf("request arg: source_pointing_vel_b_x[0]  = %e\n", argument->pointing_vel_b_x[0]);
		printf("request arg: source_pointing_vel_b_x[1]  = %e\n", argument->pointing_vel_b_x[1]);
		printf("request arg: source_pointing_vel_b_x[2]  = %e\n", argument->pointing_vel_b_x[2]);

		printf("request arg: source_pointing_pos_b_y[0]  = %e\n", argument->pointing_pos_b_y[0]);
		printf("request arg: source_pointing_pos_b_y[1]  = %e\n", argument->pointing_pos_b_y[1]);
		printf("request arg: source_pointing_pos_b_y[2]  = %e\n", argument->pointing_pos_b_y[2]);
		printf("request arg: source_pointing_vel_b_y[0]  = %e\n", argument->pointing_vel_b_y[0]);
		printf("request arg: source_pointing_vel_b_y[1]  = %e\n", argument->pointing_vel_b_y[1]);
		printf("request arg: source_pointing_vel_b_y[2]  = %e\n", argument->pointing_vel_b_y[2]);

		printf("request arg: source_pointing_pos_b_z[0]  = %e\n", argument->pointing_pos_b_z[0]);
		printf("request arg: source_pointing_pos_b_z[1]  = %e\n", argument->pointing_pos_b_z[1]);
		printf("request arg: source_pointing_pos_b_z[2]  = %e\n", argument->pointing_pos_b_z[2]);
		printf("request arg: source_pointing_vel_b_z[0]  = %e\n", argument->pointing_vel_b_z[0]);
		printf("request arg: source_pointing_vel_b_z[1]  = %e\n", argument->pointing_vel_b_z[1]);
		printf("request arg: source_pointing_vel_b_z[2]  = %e\n", argument->pointing_vel_b_z[2]);

		printf("request arg: source_pointing_epoch_a  = %e\n", argument->pointing_epoch_a);
		printf("request arg: source_pointing_epoch_b  = %e\n", argument->pointing_epoch_b);
		printf("request arg: source_pointing_parallax = %e\n", argument->pointing_parallax);
	...
	response->struct_code = argument->struct_code;
	...
	response->az[0] = xaz[0];
	response->az[1] = xaz[1];
	response->msa[0]= xmsa[0];
	response->msa[1]= xmsa[1];
	response->el[2] = relev[0];
	response->el[3] = relev[1];
	response->az[2] = raz[0];
	response->az[3] = raz[1];
	response->msa[2] = rmsa[0];
	response->msa[3] = rmsa[1];
	response->UV[0] = u;
	response->UV[1] = v;
	response->UV[2] = w;

	response->baselineP2000[0] = baselineJ2000[0];
	response->baselineP2000[1] = baselineJ2000[1];
	response->baselineP2000[2] = baselineJ2000[2];
	response->baselineV2000[0] = baselineJ2000[3];
	response->baselineV2000[1] = baselineJ2000[4];
	response->baselineV2000[2] = baselineJ2000[5];
	response->baselineA2000[0] = baselineJ2000[6];
	response->baselineA2000[1] = baselineJ2000[7];
	response->baselineA2000[2] = baselineJ2000[8];

	if(argument->verbosity >= 3)
	{
		printf("CALCServer: response->request_id = %"PRId64"\n", response->request_id);
		printf("CALCServer: response->struct_code = %"PRId64"\n", response->struct_code);
		printf("CALCServer: response->server_version = %"PRIX64"\n", response->server_version);
		printf("CALCServer: response->date  = %"PRId64"\n", response->date);
		printf("CALCServer: response->time  = %e\n", response->time);
		printf("CALCServer: response->delay[0] = %e\n", response->delay[0]);
		printf("CALCServer: response->delay[1] = %e\n", response->delay[0]);
	
		printf("CALCServer: response->dry_atmos[0] = %e\n", response->dry_atmos[0]);
		printf("CALCServer: response->dry_atmos[1] = %e\n", response->dry_atmos[1]);
		printf("CALCServer: response->dry_atmos[2] = %e\n", response->dry_atmos[2]);
		printf("CALCServer: response->dry_atmos[3] = %e\n", response->dry_atmos[3]);
		printf("CALCServer: response->wet_atmos[0] = %e\n", response->wet_atmos[0]);
		printf("CALCServer: response->wet_atmos[1] = %e\n", response->wet_atmos[1]);
		printf("CALCServer: response->wet_atmos[2] = %e\n", response->wet_atmos[2]);
		printf("CALCServer: response->wet_atmos[3] = %e\n", response->wet_atmos[3]);
	
		printf("CALCServer: response->el[0] = %e\n", response->el[0]);
		printf("CALCServer: response->el[1] = %e\n", response->el[1]);
		printf("CALCServer: response->el[2] = %e\n", response->el[2]);
		printf("CALCServer: response->el[3] = %e\n", response->el[3]);
		printf("CALCServer: response->az[0] = %e\n", response->az[0]);
		printf("CALCServer: response->az[1] = %e\n", response->az[1]);
		printf("CALCServer: response->az[2] = %e\n", response->az[2]);
		printf("CALCServer: response->az[3] = %e\n", response->az[3]);
		printf("CALCServer: response->msa[0]= %e\n", response->msa[0]);
		printf("CALCServer: response->msa[1]= %e\n", response->msa[1]);
		printf("CALCServer: response->msa[2] = %e\n", response->msa[2]);
		printf("CALCServer: response->msa[3] = %e\n", response->msa[3]);
		printf("CALCServer: response->UV = [ %e %e %e ]\n", response->UV[0], response->UV[1], response->UV[2]);

		printf("CALCServer: response->baselineP2000 = [ %e %e %e ]\n", response->baselineP2000[0], response->baselineP2000[1], response->baselineP2000[2]);
		printf("CALCServer: response->baselineV2000 = [ %e %e %e ]\n", response->baselineV2000[0], response->baselineV2000[1], response->baselineV2000[2]);
		printf("CALCServer: response->baselineA2000 = [ %e %e %e ]\n", response->baselineA2000[0], response->baselineA2000[1], response->baselineA2000[2]);
		fflush(stdout);
	}
...
/******************************************************************************/
static int_fast32_t copy_parameters(const uint_fast64_t command_number, const struct CALCSERVER9_1_RA_MODEL_PARAMETERS_ARGUMENT* const argument, struct CALCSERVER9_1_RA_MODEL_PARAMETERS_RESPONSE* const response)
{
	if(argument->verbosity >= 1)
	{
		print_current_timestamp_to_flog(command_number);
...
static int_fast32_t process_delay_command(FILE* const fp_out, const uint_fast64_t command_number)
{
	...
	static struct CALCSERVER9_1_RA_MODEL_DELAY_ARGUMENT* arguments = NULL;
	static struct CALCSERVER9_1_RA_MODEL_DELAY_RESPONSE* responses = NULL;
	int_fast32_t retval;
	...
	Bytes = uc;
	this_size = sizeof(struct CALCSERVER9_1_RA_MODEL_DELAY_ARGUMENT)*Num;
	this_response_size = sizeof(struct CALCSERVER9_1_RA_MODEL_DELAY_RESPONSE)*Num;
	if(this_size != Bytes)
	{
	...
	if(Num > MAX_Num)
	{
		arguments = (struct CALCSERVER9_1_RA_MODEL_DELAY_ARGUMENT*)realloc(arguments, this_size);
		responses = (struct CALCSERVER9_1_RA_MODEL_DELAY_RESPONSE*)realloc(responses, this_size);
	...
	for(n=0; n < Num; ++n)
	{
		retval = calc_9_1_raprog_1(command_number, n, &(arguments[n]), &(responses[n]));
		if((retval))
		{
...
static int_fast32_t process_parameters_command(FILE* const fp_out, const uint_fast64_t command_number)
{
	...
	uint32_t c;
	uint64_t uc;
	struct CALCSERVER9_1_RA_MODEL_PARAMETERS_ARGUMENT argument;
	struct CALCSERVER9_1_RA_MODEL_PARAMETERS_RESPONSE response;
	int_fast32_t retval;
	...
	Bytes = uc;
	this_size = sizeof(struct CALCSERVER9_1_RA_MODEL_PARAMETERS_ARGUMENT);
	this_response_size = sizeof(struct CALCSERVER9_1_RA_MODEL_PARAMETERS_RESPONSE);
	if(this_size != Bytes)
	{
...
/*++***********************************************************************
  %% Fortran - C interface between CALC_9_1_RA and MATHCNST.H
  Function d_mathcnst is called by the Fortran subroutine GET4 which
  is in turn called by CALC_9_1_RA. GET4 is the CALC_9_1_RA interface to the Goddard
...
/*++***********************************************************************
  %% Fortran - C interface between CALC_9_1_RA and data tables.
...
int       chr2_len;  /* string length for chr2_ptr */
/*++***********************************************************************
  %% Fortran - C interface between CALC_9_1_RA and data tables (float).
...
int       chr2_len;  /* string length for chr2_ptr */
/*++***********************************************************************
  %% Fortran - C interface between CALC_9_1_RA and data tables (int).
  Function i_ftoc is called by the Fortran subroutine GETI which
  is in turn called by CALC_9_1_RA. GETI is the CALC_9_1_RA interface to the Goddard
...
int       chr2_len;  /* string length for chr2_ptr */
/*++***********************************************************************
  %% Fortran - C interface between CALC_9_1_RA and data tables (char).
  Function c_ftoc is called by the Fortran subroutine GETA which
  is in turn called by CALC_9_1_RA. GETA is the CALC_9_1_RA interface to the Goddard
...
int       chr1_len;  /* string length for chr1_ptr */
/*++***********************************************************************
  %% Fortran - C interface between CALC_9_1_RA and job table (return num_rows).
  Function n_rows is called by one of the Fortran GETx subroutines which
  are in turn called by CALC_9_1_RA. Function n_rows gets the number of rows in
...
/* copy the Fortran string into an array */
	...
	if (strcmp (inword, "METRO") == 0)
	{
		if (p_arg->pressure_b < 1.0)
			return (0);
		else if(((p_arg->station_a[0] != 'E') || (p_arg->station_a[1] != 'C') || (p_arg->station_a[2] != 0)) && (p_arg->pressure_a < 1.0))
			return (0);
	...
	if ((strcmp(in_tblname, "STATION")) == 0)
	{
		...
		if(strncmp(in_keyword, "POINT", 5) == 0)
		{
			if(strncmp(in_keyword, "POINTPOS", 8) == 0)
			{
				...
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_x[0]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_x[0]);
				}
				if ((strcmp(in_keyword, "POINTPOSXY")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_x[1]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_x[1]);
				}
				if ((strcmp(in_keyword, "POINTPOSXZ")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_x[2]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_x[2]);
				}
				if ((strcmp(in_keyword, "POINTPOSYX")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_y[0]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_y[0]);
				}
				if ((strcmp(in_keyword, "POINTPOSYY")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_y[1]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_y[1]);
				}
				if ((strcmp(in_keyword, "POINTPOSYZ")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_y[2]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_y[2]);
				}
				if ((strcmp(in_keyword, "POINTPOSZX")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_z[0]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_z[0]);
				}
				if ((strcmp(in_keyword, "POINTPOSZY")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_z[1]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_z[1]);
				}
				if ((strcmp(in_keyword, "POINTPOSZZ")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_pos_a_z[2]);
					if(row_num == 1)
						return (p_arg->pointing_pos_b_z[2]);
				}
			}
			if(strncmp(in_keyword, "POINTVEL", 8) == 0)
			{
				...
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_x[0]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_x[0]);
				}
				if ((strcmp(in_keyword, "POINTVELXY")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_x[1]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_x[1]);
				}
				if ((strcmp(in_keyword, "POINTVELXZ")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_x[2]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_x[2]);
				}
				if ((strcmp(in_keyword, "POINTVELYX")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_y[0]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_y[0]);
				}
				if ((strcmp(in_keyword, "POINTVELYY")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_y[1]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_y[1]);
				}
				if ((strcmp(in_keyword, "POINTVELYZ")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_y[2]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_y[2]);
				}
				if ((strcmp(in_keyword, "POINTVELZX")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_z[0]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_z[0]);
				}
				if ((strcmp(in_keyword, "POINTVELZY")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_z[1]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_z[1]);
				}
				if ((strcmp(in_keyword, "POINTVELZZ")) == 0)
				{
					if(row_num == 0)
						return (p_arg->pointing_vel_a_z[2]);
					if(row_num == 1)
						return (p_arg->pointing_vel_b_z[2]);
				}
			}
			if ((strcmp(in_keyword, "POINTEPOCH")) == 0)
				return (p_arg->source_epoch);
			if ((strcmp(in_keyword, "POINTPARALLAX")) == 0)
				return (p_arg->source_parallax);
		}
	}
	...
	if ((strcmp(in_tblname, "SOURCE")) == 0)
	{
		...
		else
		{
			...
			if ((strcmp(in_keyword, "SPOS_X")) == 0)
				return (p_arg->source_pos[0]);
			if ((strcmp(in_keyword, "SPOS_Y")) == 0)
				return (p_arg->source_pos[1]);
			if ((strcmp(in_keyword, "SPOS_Z")) == 0)
				return (p_arg->source_pos[2]);
			if ((strcmp(in_keyword, "SVEL_X")) == 0)
				return (p_arg->source_vel[0]);
			if ((strcmp(in_keyword, "SVEL_Y")) == 0)
				return (p_arg->source_vel[1]);
			if ((strcmp(in_keyword, "SVEL_Z")) == 0)
				return (p_arg->source_vel[2]);
 ...
 -*/
{
	...
	if ((strcmp(in_tblname, "METRO")) == 0)
	{
		...
		{
			if (row_num == 0)
				value = (float)p_arg->pressure_a;
			else
				value = (float)p_arg->pressure_b;
			return (value);
		}
 ...
 -*/
{
	...
	if ((strcmp (in_tblname, "STATION")) == 0)
	{
		...
		{
			double sum =
				fabs(p_arg->pointing_pos_a_z[0])
				+ fabs(p_arg->pointing_pos_a_z[1])
				+ fabs(p_arg->pointing_pos_a_z[2])
				+ fabs(p_arg->pointing_pos_b_z[0])
				+ fabs(p_arg->pointing_pos_b_z[1])
				+ fabs(p_arg->pointing_pos_b_z[2]);
			return ((sum > 0.0) ? 1:0);
		}
	} 
	if ((strcmp(in_tblname, "SOURCE")) == 0)
	{
		...
		{
			double sum =
				fabs(p_arg->source_pos[0])
				+ fabs(p_arg->source_pos[1])
				+ fabs(p_arg->source_pos[2]);
			return ((sum > 0.0) ? 1:0);
		}
 ...
 * RETURN ???
 *
 * retrieves the ocean loading coefficients for CALC_9_1_RA
 -*/
{
	int i, j, imode, istn;
...
/*  @(#)CALC_9_1_RA5Server.c  version 1.2  created 00/08/27 14:45:22
...
char *chr1_ptr;		/* pointer to first character string to be written */
char *chr2_ptr;		/* pointer to second character string to be written */
short *p_i2char;         /* number of integer*2 characters for CALC_9_1_RA */
int chr1_len;		/* length of first character string */
int chr2_len;		/* length of second character string */
/*
 * This function is a FORTRAN callable subroutine to write two character 
...
char *chr1_ptr;		/* pointer to first character string to be written */
char *chr2_ptr;		/* pointer to second character string to be written */
short *p_i2char;         /* number of char*1 characters for CALC_9_1_RA */
int chr1_len;		/* length of first character string */
int chr2_len;		/* length of second character string */
/*
 * This function is a FORTRAN callable subroutine to write two character 
...
/*
  ...
  ctskPerror (ctskERROR, 0x1122,"CALC_9_1_RA ERROR");
*/
	free (inword);
	free (in2word);
}
 ...
 * that are called by CALC_9_1_RA.  The maximum character string length in the CALC_9_1_RA
