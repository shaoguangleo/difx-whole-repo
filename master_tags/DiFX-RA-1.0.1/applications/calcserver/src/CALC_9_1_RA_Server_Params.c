...
/******************************************************************************/
int
process_DiFX_Delay_Server_Parameters_1_CALC_9_1_RAPROG(const struct getDIFX_DELAY_SERVER_PARAMETERS_1_arg* const argument, struct DIFX_DELAY_SERVER_PARAMETERS_1_res* const res)
{
    res->server_error =   0;
    res->model_error =    0;
