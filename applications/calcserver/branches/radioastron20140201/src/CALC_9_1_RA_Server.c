...
*/
{
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 0\n");    
    tp = &timep;
    time (tp);
...
#warning "remove the following line when CALC_9_1_RA is fixed to support msa"
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 1\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 2\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 3\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 4\n");
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 4.1\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 4.2\n");
    sock_in = svc_getcaller (pTransport);
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 4.3\n");
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 5\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 6\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 7\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 8\n"); 

    if (!svc_sendreply (pTransport, xdr_getCALC_9_1_RA_res, (char *)&result))
	svcerr_systemerr (pTransport);
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 9\n"); 
    ...
    fprintf(stderr, "JMA DEBUG: inside calc_9_1_raprog_1 10\n"); 
}
