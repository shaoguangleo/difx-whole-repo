    ...
    */
    ...
    private void initComponents() {
        ...
        clusterPanelLayout.setHorizontalGroup(
            ...
            .addComponent(clusterScrollPane, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 818, Short.MAX_VALUE)
        );
        ...
        closeButton.setToolTipText("Using the \"Close\" button will destroy the window and its contents - all settings changes will be lost.  This is different from the \"Hide\" button (the \"X\" in the upper left of the frame) which simply makes the window invisible.  ");
