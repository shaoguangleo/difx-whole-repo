...
#
# $Id: difxresource.py 10143 2021-09-10 14:54:38Z HelgeRottmann $
# $HeadURL: https://svn.atnf.csiro.au/difx/sites/MPIfR/misc/difxresource/difxresource.py $
# $LastChangedRevision: 10143 $
# $Author: HelgeRottmann $
# $LastChangedDate: 2021-09-10 16:54:38 +0200 (Fri, 10 Sep 2021) $
#
#============================================================================
...
rate["FILE"]=16000.0
rate["FAKE"]=16000.0  # needed for v2d source=fake in eg regression tests
...
for ds in difx.metainfo.datastreams:
    ...
    if ds.datasource == "FILE":
        if len(difx.metainfo.data[dsIdx].media) < 1:
            # print("Datastream %d has no files" % (dsIdx))
            pass
