/*  @(#)CALCServer.h  version 1.01  created 2012Feb16 14:40
...
#define MAX_STR 32
#define CALC_SERVER_STRUCT_CODE_0 0x0        /* Request for the calcserver
                                                program to send back the current
                                                program version as a
                                                struct_code value in the
                                                request_id element slot
                                                through a struct_code=
                                                CALC_SERVER_STRUCT_CODE_5_0_0
                                                call.
                                              */
#define CALC_SERVER_STRUCT_CODE_5_0_0 150    /* Original version 5 */
#define CALC_SERVER_STRUCT_CODE_5_1_0 0x0510 /* Include spacecraft capabilities by James M Anderson */
#define CALC_SERVER_STRUCT_CODE_CURRENT CALC_SERVER_STRUCT_CODE_5_1_0
...
struct getCALC_arg {
        ...
        long struct_code;       /* CALC Server struct code.  This specifies
                                   ...
                                   CALC_SERVER_STRUCT_CODE_* for allowed
                                   options.
                                */
