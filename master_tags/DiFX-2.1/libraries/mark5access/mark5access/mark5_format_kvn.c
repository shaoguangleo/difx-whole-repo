...
//
// $Id: mark5_format_mark5b.c 4087 2011-12-08 22:53:13Z WalterBrisken $
// $HeadURL: https://svn.atnf.csiro.au/difx/master_tags/DiFX-2.1/libraries/mark5access/mark5access/mark5_format_mark5b.c $
// $LastChangedRevision: 4087 $
// $Author: WalterBrisken $
// $LastChangedDate: 2011-12-09 06:53:13 +0800 (Fri, 09 Dec 2011) $
//
//============================================================================

// KVN has a non-standard bit pattern in many of their nominally mark5b recording streams. 
// It seemed simpler to split of a copy of mark5_format_mark5b to host these differences. 
...
{ // KVN mode 3: [64MHz-2b]*4stream (1024 MBps, 32MHz clock)
	...
	ms->readposition = i;
	if (o!=nsamp) printf("Nsamp %d, Used %d\n",nsamp,o);
...
{
	snprintf(ms->formatname, MARK5_STREAM_ID_LENGTH, "Mkvn5B-%d-%d-%d", 
...
struct mark5_format_generic *new_mark5_format_kvn5b(int Mbps,
 ...
 */
{
	...
	{
	  fprintf(m5stderr, "Illegal combination of decimation, bitstreams and bits (%d %d %d)\n",
		  decimation,nbitstream,nbit);
		free(f);
		free(m);
