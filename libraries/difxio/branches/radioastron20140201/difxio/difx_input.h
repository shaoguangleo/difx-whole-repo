...
typedef struct
{
	...
	double iono[MAX_MODEL_ORDER+1];		/* (us/sec^n) */
...
typedef struct
{
	...
	*/
	...
	double d2Delay_dldn[MAX_MODEL_ORDER+1]; /* (us/sec^n/rad^1); n=[0, order] */
	double d2Delay_dmdm[MAX_MODEL_ORDER+1]; /* (us/sec^n/rad^2); n=[0, order] */
	double d2Delay_dmdn[MAX_MODEL_ORDER+1]; /* (us/sec^n/rad^1); n=[0, order] */
	double d2Delay_dndn[MAX_MODEL_ORDER+1]; /* (us/sec^n/rad^0); n=[0, order] */
