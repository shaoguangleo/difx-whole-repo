...
#ifndef DelayHandlerCalcServer9_1_h
#define DelayHandlerCalcServer9_1_h
...
class DelayHandlerCalcServer9_1 : public DelayHandlerBase{

public:
	DelayHandlerCalcServer9_1(const int_fast32_t NUM_THREADS_, int_fast32_t verbosity_) throw();
    virtual ~DelayHandlerCalcServer9_1();




protected:
	struct CALCSERVER9_1_MODEL_DELAY_ARGUMENT** local_arg;
	struct CALCSERVER9_1_MODEL_DELAY_RESPONSE** local_res;
	struct CALCSERVER9_1_MODEL_PARAMETERS_ARGUMENT local_parg;
	struct CALCSERVER9_1_MODEL_PARAMETERS_RESPONSE local_pres;
...
private:
    ...
    // prevent copying
    DelayHandlerCalcServer9_1(const DelayHandlerCalcServer9_1& a);
    DelayHandlerCalcServer9_1& operator=(const DelayHandlerCalcServer9_1& a);
};
...
#endif // DelayHandlerCalcServer9_1_h
