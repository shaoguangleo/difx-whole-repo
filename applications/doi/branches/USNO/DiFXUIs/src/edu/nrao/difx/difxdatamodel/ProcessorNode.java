...
public class ProcessorNode extends DiFXObject {
    ...
    protected float bogusGHz;
    protected short type;         // support different type of nodes
    protected String typeString;
    // -- status fields
    protected String state;
    protected float cpuLoad;
    protected float memLoad;
    protected long totalMem;
    protected long usedMem;
    protected int netRxRate;
    protected int netTxRate;
